  ...
  if (authStep === 'welcome') return (
    <div style={wrapStyle}>
      <div style={{ textAlign: 'center' }}>
        <img src="/logo-icon.svg" alt="Praxi Pro" style={{ width: 80, height: 80, borderRadius: 18, marginBottom: 4 }} />
      ...
      <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 10, marginTop: 8 }}>
        ...
        <button onClick={signInWithGoogle} style={{ ...bigBtn('white', '#3c4043', g.surfaceBorder), display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10 }}>
